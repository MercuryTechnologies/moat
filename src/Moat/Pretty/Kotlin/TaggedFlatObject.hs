module Moat.Pretty.Kotlin.TaggedFlatObject
  ( prettyKotlinData,
    TaggedFlatObject (..),
  )
where
...
prettyKotlinData :: TaggedFlatObject -> MoatData -> String
prettyKotlinData TaggedFlatObject {} = \case
  MoatStruct {..} ->
    ""
